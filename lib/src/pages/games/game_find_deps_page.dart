...
class GameFindDepsPage extends StatefulWidget {
  static const String titlePage = 'Busca Departamentos';
  static const String route = '/game_busca_departamentos_page';
  static const IconData icon = Icons.map_outlined;
  GameFindDepsPage({Key? key}) : super(key: key);

  @override
  State<GameFindDepsPage> createState() => _GameFindDepsPageState();
}

class _GameFindDepsPageState extends State<GameFindDepsPage> {
