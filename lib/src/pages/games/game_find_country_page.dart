...
class GameFindCountryPage extends StatefulWidget {
  static const String titlePage = 'Busca Departamentos';
  static const String route = '/game_busca_paises_mundo_page';
  static const IconData icon = Icons.map_outlined;
  GameFindCountryPage({Key? key}) : super(key: key);

  @override
  State<GameFindCountryPage> createState() => _GameFindCountryPageState();
}

class _GameFindCountryPageState extends State<GameFindCountryPage> {
  ...
  String _dataStringJson = Constantes.mapaMundoJson;
